...
CREATE TABLE CUSTOMER (
  ...
  C_SINCE DATE DEFAULT CURRENT_DATE NOT NULL,
...
CREATE TABLE HISTORY (
  ...
  H_DATE DATE DEFAULT CURRENT_DATE NOT NULL,
...
CREATE TABLE ORDERS (
  ...
  O_D_ID INT DEFAULT '0' NOT NULL,
  O_W_ID SMALLINT DEFAULT '0' NOT NULL,
  O_ENTRY_D DATE DEFAULT CURRENT_DATE NOT NULL,
...
CREATE TABLE NEW_ORDER (
  ...
  NO_D_ID INT DEFAULT '0' NOT NULL,
