CREATE TABLE WAREHOUSE (
  W_ID SMALLINT DEFAULT '0' PRIMARY KEY NOT NULL,
...
CREATE UNIQUE INDEX IDX_CUSTOMER_UNIQUE ON CUSTOMER (C_W_ID,C_D_ID,C_LAST,C_FIRST);
...
CREATE UNIQUE INDEX IDX_ORDERS_UNIQUE ON ORDERS(O_W_ID,O_D_ID,O_C_ID,O_ID);
